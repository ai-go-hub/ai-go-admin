...
INSERT INTO "__PREFIX__configs" ("id", "name", "group", "title", "tip", "type", "value", "dict", "rule", "input_extend", "allow_del", "weigh") VALUES
    ...
    (3,  'entrance',             'basic',          '自定义后台入口',   NULL,                                   'string',   '/admin',                                                                                                          NULL,    'required', NULL,  0, 98),
    (4,  'record_number',        'basic',          '域名备案号',       NULL,                                   'string',   '渝ICP备8888888号-1',                                                                                              NULL,    NULL,         NULL,  0, 97),
    ...
    (13, 'quick_entrance',       'quick_entrance', '快捷配置入口',     NULL,                                   'array',     '[{"key":"个人资料","value":"routine/adminInfo"}]',                                                                NULL,    NULL,         NULL,  0, 0)
