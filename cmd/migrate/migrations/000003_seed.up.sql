...
INSERT INTO "__PREFIX__admin_rules" ("id", "pid", "type", "title",           "name",                     "path",                 "icon",                    "open_type", "url", "component",                                     "keepalive", "extend", "remark", "weigh", "status", "updated_at", "created_at") VALUES
    ...
    (15, 14,   'node', '查看',           'auth/rule/index',          '',                     '',                        '',          '',    '',                                              1,           '',       '',       0,       1,        NOW(),        NOW()),
    (16, 14,   'node', '添加',           'auth/rule/add',            '',                     '',                        '',          '',    '',                                              1,           '',       '',       0,       1,        NOW(),        NOW()),
    (17, 14,   'node', '编辑',           'auth/rule/edit',           '',                     '',                        '',          '',    '',                                              1,           '',       '',       0,       1,        NOW(),        NOW()),
    (18, 14,   'node', '删除',           'auth/rule/del',            '',                     '',                        '',          '',    '',                                              1,           '',       '',       0,       1,        NOW(),        NOW()),
    ...
    (21, 20,   'node', '查看',           'auth/adminLog/index',      '',                     '',                        '',          '',    '',                                              1,           '',       '',       0,       1,        NOW(),        NOW()),
    ...
    (24, 23,   'node', '查看',           'routine/config/index',     '',                     '',                        '',          '',    '',                                              1,           '',       '',       0,       1,        NOW(),        NOW()),
    (25, 23,   'node', '编辑',           'routine/config/edit',      '',                     '',                        '',          '',    '',                                              1,           '',       '',       0,       1,        NOW(),        NOW()),
    ...
    (27, 26,   'node', '查看',           'routine/attachment/index', '',                     '',                        '',          '',    '',                                              1,           '',       '',       0,       1,        NOW(),        NOW()),
    (28, 26,   'node', '编辑',           'routine/attachment/edit',  '',                     '',                        '',          '',    '',                                              1,           '',       '',       0,       1,        NOW(),        NOW()),
    (29, 26,   'node', '删除',           'routine/attachment/del',   '',                     '',                        '',          '',    '',                                              1,           '',       '',       0,       1,        NOW(),        NOW()),
    (30, 22,   'menu', '个人资料',       'routine/adminInfo',        'routine/adminInfo',    'lucide-user',             'tab',       '',    '/src/views/admin/routine/adminInfo.vue',        1,           '',       '',       97,      1,        NOW(),        NOW()),
    (31, 30,   'node', '查看',           'routine/adminInfo/index',  '',                     '',                        '',          '',    '',                                              1,           '',       '',       0,       1,        NOW(),        NOW()),
    (32, 30,   'node', '编辑',           'routine/adminInfo/edit',   '',                     '',                        '',          '',    '',                                              1,           '',       '',       0,       1,        NOW(),        NOW())
ON CONFLICT DO NOTHING;
