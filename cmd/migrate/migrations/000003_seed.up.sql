...
INSERT INTO "__PREFIX__configs" ("id", "name", "group", "title", "tip", "type", "value", "dict", "rule", "input_extend", "allow_del", "weigh") VALUES
	...
	(5,  'no_access_ip',         'basic',          '禁止访问 IP',      '禁止访问站点的IP列表，一行一个',        'textarea',   NULL,                                                                                                              NULL,    NULL,         NULL,  0, 96),
	(6,  'smtp_server',          'mail',           'SMTP 服务器',      NULL,                                   'string',   'smtp.com',                                                                                                       NULL,    NULL,         NULL,  0, 99),
	(7,  'smtp_port',            'mail',           'SMTP 端口',        NULL,                                   'string',   '465',                                                                                                            NULL,    NULL,         NULL,  0, 98),
	(8,  'smtp_user',            'mail',           'SMTP 用户',        NULL,                                   'string',   NULL,                                                                                                              NULL,    NULL,         NULL,  0, 97),
	...
	(12, 'quick_entrance',       'quick_entrance', '快捷配置入口',     NULL,                                   'array',     '[{"key":"个人资料","value":"routine/adminInfo"}]',                                                                NULL,    NULL,         NULL,  0, 0)
